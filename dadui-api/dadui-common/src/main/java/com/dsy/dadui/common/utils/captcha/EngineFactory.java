...
public class EngineFactory {
	...
	public static CaptchaEngine getCaptchaEngine(final int width, final int height,
			Class<? extends CaptchaEngine> engineClazz) {
	...
	public static synchronized CaptchaEngine createCaptchaEngine(String key, final int width, final int height,
			Class<? extends CaptchaEngine> engineClazz) {
		CaptchaEngine engine = engineMap.get(key);
		if (engine != null) {
			return engine;
